...
from core.dtos.users_create import UserCreateDTO
...
async def create_user(
    ...
    user_dto = UserCreateDTO(email=email, password=password, is_active=False, is_epen_user=False, is_admin=False)

    try:
        user_db=await users_use_case.create_user(user_dto)
