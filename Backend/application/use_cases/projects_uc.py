...
class ProjectUseCase:
    ...
    async def create_project(self, project_dto: ProjectCreateDTO) -> Project:
        ...
        project_file_path = await self.file_manager.save_file(
            file=project_dto.project_file, destination_path=project_file_dir
        )
        ...
        updated_project: Project = self.project_repo.add_project_file(
            project_id=project.id, file_path=project_file_path
        )
