...
from domain.entities.statuses import Status  # Importa la clase Status para las relaciones
from domain.entities.correction_reports import CorrectionReport  # Importa la clase CorrectionReport para las relaciones
from domain.entities.ttals_nps import Transmittal_NP  # Importa la clase Transmittal_NP para las relaciones
